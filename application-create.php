...
<div class="pagetitle"><h1>Add Application</h1><p>Create a new rental application.</p></div>
...
<div class="col-12"><button class="btn btn-primary"><i class="bi bi-check-lg"></i> Save Application</button> <a href="applications.php" class="btn btn-secondary">Cancel</a></div>
