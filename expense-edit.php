...
<div class="pagetitle"><h1>Edit Expense</h1><p>Update the selected property expense.</p></div>
...
<div class="col-12"><button class="btn btn-primary"><i class="bi bi-check-lg"></i> Save Changes</button> <a href="expenses.php" class="btn btn-secondary">Cancel</a></div>
</form>
</div></div>
</section>
