...
$pageTitle = 'Edit Meter Reading'; require __DIR__.'/includes/header.php'; ?>

<!-- ============================================================
     3. PAGE CONTENT
     ============================================================ -->

<main id="main" class="main"><div class="pagetitle"><h1>Edit Meter Reading</h1><p>Update the meter reading and billing rate.</p></div><section class="section"><div class="mn-card"><div class="mn-card-body"><form class="row g-3">
...
<div class="col-12"><div class="mn-alert mn-alert-info">Usage = current reading − previous reading. The resulting utility charge can then be included on the tenant's invoice.</div></div><div class="col-12"><button class="btn btn-primary">Save Changes</button> <a href="utility-readings.php" class="btn btn-secondary">Cancel</a></div>
