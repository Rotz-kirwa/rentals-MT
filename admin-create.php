...
<main id="main" class="main">
  <div class="pagetitle"><h1>Add Administrator</h1><p>Create an admin account and assign exactly what the user can access.</p></div>
    ...
    <div class="card">
      <div class="card-body">
        <form method="post" action="#" class="row g-4">
          ...
          <div class="col-12">
            <button type="submit" class="btn btn-primary"><i class="bi bi-person-plus"></i> Create Administrator</button>
