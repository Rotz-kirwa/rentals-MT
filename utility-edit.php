...
$pageTitle = 'Edit Utility'; require __DIR__.'/includes/header.php'; ?>

<!-- ============================================================
     3. PAGE CONTENT
     ============================================================ -->

<main id="main" class="main"><div class="pagetitle"><h1>Edit Utility</h1><p>Update the utility name, billing method or rate.</p></div><section class="section"><div class="mn-card"><div class="mn-card-body">
...
<div class="col-12"><button class="btn btn-primary">Save Changes</button> <a href="utilities.php" class="btn btn-secondary">Cancel</a></div>
