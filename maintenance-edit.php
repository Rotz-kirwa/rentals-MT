...
<div class="pagetitle"><h1>Edit Maintenance Request</h1><p>Log a repair or maintenance job against a property or house.</p></div>
...
<div class="col-12"><button class="btn btn-primary"><i class="bi bi-tools"></i> Save Changes</button> <a href="maintenance.php" class="btn btn-secondary">Cancel</a></div>
