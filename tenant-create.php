...
<div class="col-md-4"><label class="form-label">Phone</label><input class="form-control" placeholder="07XX XXX XXX"></div><div class="col-md-4"><label class="form-label">National ID</label><input class="form-control"></div><div class="col-md-4"><label class="form-label">Emergency Contact</label><input class="form-control"></div>
<div class="col-12"><div class="mn-form-section">Rental Details</div></div>
<div class="col-md-6"><label class="form-label">Attached Property</label><select class="form-select"><option>My Nyumba Apartments</option><option>Ngong View</option></select></div>
<div class="col-md-6"><label class="form-label">House</label><select class="form-select"><option>B12 — KSh 18,000</option><option>A04 — KSh 15,000</option></select></div>
